    ...
    public function it_works_with_custom_tenant_entity_that_extends_default()
    {
        ...
        $this->app->bind($customTenantClass, function () {
            return new class implements TenantEntityInterface {
                ...
                public function name(): TenantName { return $this->name; }
                public function domain(): Domain { return $this->domain; }
                public function updateName(TenantName $name): void { $this->name = $name; }
                public function updateDomain(Domain $domain): void { $this->domain = $domain; }
    ...
    public function it_handles_custom_tenant_entity_with_different_structure()
    {
        ...
        $this->app->bind($customTenantClass, function () {
            return new class implements TenantEntityInterface {
                ...
                public function name(): TenantName { return $this->tenantName; }
                public function domain(): Domain { return $this->tenantDomain; }
                public function updateName(TenantName $name): void { $this->tenantName = $name; }
                public function updateDomain(Domain $domain): void { $this->tenantDomain = $domain; }
